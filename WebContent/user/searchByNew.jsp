						...
						<div class="row">
							<div class="col-md-12" style="margin: auto;">
								...
								<ul class="pagination" id="myul" style="display: block; text-align: center;">
									<s:if test="curPage != 1">
										<li>
											<a href="${pageContext.request.contextPath }/book_searchByNew?curPage=1&keyword=<s:property value="keyword"/>">首页</a>
										</li>
										<li>
											<a href="${pageContext.request.contextPath }/book_searchByNew?curPage=<s:property value="curPage-1" />&keyword=<s:property value="keyword"/>">上一页</a>
										</li>
									</s:if>
										<li class="active">
									...
									<s:if test="curPage != totalPage && totalPage != 0">
										<li>
											<a href="${pageContext.request.contextPath }/book_searchByNew?curPage=<s:property value="curPage+1" />&keyword=<s:property value="keyword"/>">下一页</a>
										</li>
										<li>
											<a href="${pageContext.request.contextPath }/book_searchByNew?curPage=<s:property value="totalPage" />&keyword=<s:property value="keyword"/>">尾页</a>
										</li>
									</s:if>
								</ul>
							</div>
